...
export function buildPrompt(
  ...
  return [
    ...
    "Dirigite al usuario por su nombre cuando lo tengas disponible, pero usalo con moderación: como mucho una vez por hilo, y no repitas un saludo en cada respuesta.",
    ...
    "10. SALUDOS: abrí la conversación con un saludo ('¡Hola!' y el nombre si está disponible) SOLO cuando no haya turnos previos en el HISTORIAL RECIENTE, es decir en la primera consulta del hilo. Si ya hay historial, entrá directo al tema: no vuelvas a saludar ni a repetir el nombre en cada respuesta, eso suena robótico y repetitivo.",
    "",
